...
class InputRound extends Component<Props, State> {
  state = {
    round: {
      teamRounds: [new TeamRound([dBet, dBet], 50, false), new TeamRound([dBet, dBet], 50, false)],
      startTime: new Date(),
      endTime: new Date(),
    },
      ...
      <>
        <div className={c.root}>
          ...
          <Grid container spacing={2} className={c.mb2}>
            ...
            <Grid item xs={12} className={c.slider}>
              <InputPoints points={teamB.points} onChange={(v) => this.handleSlide(v)} />
            </Grid>
          </Grid>
        ...
        <Paper className={c.paper}>
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <Button className={c.w100} component={Link} to="/rounds" startIcon={<ListIcon />}>
                Rounds
              </Button>
            </Grid>
            <Grid item xs={6}>
